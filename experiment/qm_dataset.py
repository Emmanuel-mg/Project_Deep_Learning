...
for i in dataset:
    tot += i['y'][0,2]
mean_tot = tot/len(dataset)
print("This is the mean of the corresponding parameters", mean_tot)

error = 0
for j in dataset:
    error += (mean_tot - j['y'][0,2])**2
print("This is the corresponding loss", error/len(dataset))
# fig = plt.figure()
